...
//         className="will-change-transform text-5xl text-center text-transparent bg-radial text-shadow-2xl from-[#b1afb1] to-[#291d29] bg-clip-text font-semibold"
//       >
//         Work Experience
//       </motion.h3>
...
//         className="h-full p-4 items-center justify-center flex-col w-full border border-neutral-900 shadow-2xl/22 shadow-[#6b6a6a] flex gap-12 rounded-2xl py-8"
//       >
//         <motion.div 
...
//             whileHover="hover"
//             whileTap={{ scale: 0.9 }}
//             className="px-2 py-1 rounded-2xl bg-gradient-to-t from-[#edeaeac2] to-[#34333300] shadow-xl/45 cursor-pointer shadow-[#6d6d6d] will-change-transform"
//           >
//             <img
//               className="rounded-2xl h-10 w-20"
...
//               ease: [0.25, 0.1, 0.25, 1]
//             }}
//             className='text-xl font-light uppercase text-center'
//           >
//             Contributed to two projects at Octoreal, focusing on:
//           </motion.p>
//         </motion.div>
 
//         <div className="flex flex-col h-full w-full items-center p-3 gap-8">
//           <motion.div
//             variants={itemVariants}
//             whileHover={{ 
//               y: -5, 
...
//               }
//             }}
//             className="h-full w-3/4 flex-col flex border border-[#292828] rounded-xl shadow-xl/10 shadow-[#373636] items-center gap-1 p-8 will-change-transform"
//           >
//             <h3 className="text-lg font-medium uppercase text-neutral-300 my-2">
...
//               }
//             }}
//             className="w-1/2 h-full flex flex-col items-center border border-[#1e1c1c] rounded-xl shadow-xl/20 shadow-[#373636] gap-1 p-8 will-change-transform"
//           >
//             <h3 className="text-lg font-medium uppercase text-transparent bg-gradient-to-t from-[#ddc1ef] to-[#5a8189] bg-clip-text my-2">
//               Technologies Used
//             </h3>
//             <p className="text-transparent bg-gradient-to-t from-[#5b5c5c] to-[#bdeded] bg-clip-text font-medium">
